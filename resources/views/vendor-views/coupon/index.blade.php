        ...
        <div class="row mt-20">
            <div class="col-md-12">
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="d-flex flex-wrap  gap-3 align-items-center justify-content-between">
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <div class="dropdown">
                                    <a type="button" class="btn btn-outline--primary text-nowrap h-100"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <button class="btn btn-outline-info btn-sm square-btn get-quick-view"
                                                    data-id="{{ $coupon['id'] }}">
                    ...
                    @if(count($coupons)==0)
                        @include('layouts.vendor.partials._empty-state',['text'=>'no_coupon_found'],['image'=>'default'])
                    @endif
                </div>
            </div>
        </div>
