                ...
                <div class="position-relative">
                    <div class="cover-img h-550 h-md-350">
                        <img class="w-100 h-100 object-fit-cover rounded-10" alt=""
                            src="{{ getStorageImages(path: getWebConfig(name: 'shop_banner'), type: 'backend-banner', source: dynamicAsset('public/assets/new/back-end/img/inhouse-banner.png')) }}">
                    </div>
                    ...
                    <div
                        ...
                        <div class="position-relative z-1">
                            <img height="120" width="120" class="shadow-lg rounded mt-n10 p-20 p-sm-30 bg-white mt-n50"
                            ...
                            <div class="d-flex flex-wrap gap-3 justify-content-between mb-4">
                                <div>
                                    <h3 class="text-capitalize">
                                        {{ getWebConfig(name: 'company_name') }} {{ translate('shop') }}</h3>
                                    <p class="fs-12 mb-0">
