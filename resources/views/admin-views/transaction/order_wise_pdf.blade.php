            ...
            <table class="bs-0">
                <tr>
                    <td class="p-0 text-left">
                        <b class="bold black"> {{ translate('date') }}</b> : {{ date('F d, Y') }}
        ...
        <td class="pt-0">
            <table class="bs-0 __product-table inter">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $transaction?->order?->refer_and_earn_discount), currencyCode: getCurrencyCode()) }}
                    </td>
                </tr>
                <tr>
...
<table class="content-position">
    ...
    <tr>
        ...
        <td class="text-right">
            ...
            @php($admin_referral_Discount = $transaction?->order?->refer_and_earn_discount ?? 0)
            ...
            {{ setCurrencySymbol(amount: usdToDefaultCurrency(amount: $admin_coupon_discount+$admin_shipping_discount+$admin_referral_Discount), currencyCode: getCurrencyCode()) }}
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td class="text-right">
            ...
            $admin_net_income -= $transaction->order->refer_and_earn_discount;
            ...
            echo setCurrencySymbol(amount: usdToDefaultCurrency(amount: $admin_net_income), currencyCode: getCurrencyCode());
            ?>
        </td>
    </tr>
    <tr>
        ...
        <td class="text-right">
            ...
            if ($transaction['seller_is'] == 'seller') {
                $seller_net_income += $transaction->order->refer_and_earn_discount;
