                        ...
                        <form action="{{route('admin.coupon.add')}}" method="POST">
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-6 col-lg-4">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('coupon_type')}}</label>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('coupon_title')}}</label>
                                ...
                                <div class="col-md-6 col-lg-4 first_order">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('coupon_bearer')}}</label>
                                    <div class="select-wrapper">
                                ...
                                <div class="col-md-6 col-lg-4 coupon_by first_order">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('vendor')}}</label>
                                    <select
                                        class="custom-select"
                                ...
                                <div class="col-md-6 col-lg-4 coupon_type first_order">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('customer')}}</label>
                                    <select
                                        class="custom-select"
                                        name="customer_id">
                                ...
                                <div class="col-md-6 col-lg-4 first_order">
                                    <label
                                        ...
                                        class="form-label d-flex">{{translate('limit_for_same_user')}}</label>
                                ...
                                <div class="col-md-6 col-lg-4 free_delivery">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('discount_type')}}</label>
                                    <div class="select-wrapper">
                                ...
                                <div class="col-md-6 col-lg-4 free_delivery">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('discount_Amount')}}
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('minimum_purchase')}}
                                        ($)</label>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('start_date')}}</label>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label for="name"
                                           class="form-label d-flex">{{translate('expire_date')}}</label>
