                    ...
                    <form action="{{route('admin.coupon.update',[$coupon['id']]) }}" method="post">
                        ...
                        <div class="row g-4 mb-4">
                            <div class="col-md-6 col-lg-4">
                                <label for="name" class="form-label">{{translate('coupon_type') }}</label>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <label for="name" class="form-label">{{translate('coupon_title')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4 first_order">
                                <label for="name" class="form-label">{{translate('coupon_bearer')}}</label>
                                <div class="select-wrapper">
                            ...
                            <div class="col-md-6 col-lg-4 coupon_by first_order">
                                <label for="name" class="form-label">{{translate('vendor')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4 coupon_type first_order">
                                <label for="name" class="form-label">{{translate('customer')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4 first_order">
                                <label  for="exampleFormControlInput1" class="form-label">{{translate('limit_for_same_user')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4 free_delivery">
                                <label  for="name" class="form-label">{{translate('discount_type')}}</label>
                               <div class="select-wrapper">
                            ...
                            <div class="col-md-6 col-lg-4 free_delivery">
                                <label for="name" class="form-label">{{translate('discount_Amount')}} <span id="discount_percent"> (%)</span></label>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <label for="name" class="form-label">{{translate('minimum_purchase')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4 free_delivery" id="max-discount">
                                <label for="name" class="form-label">{{translate('maximum_discount')}}</label>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <label for="name" class="form-label">{{translate('expire_date')}}</label>
