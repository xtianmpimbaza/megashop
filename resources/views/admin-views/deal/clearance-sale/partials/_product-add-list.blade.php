                                ...
                                <td>
                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                        ...
                                        @else
                                            ...
                                            @if(isset($clearanceConfig->discount_type) && $clearanceConfig->discount_type == 'product_wise')
                                                <a href="#discount-update-modal" data-bs-toggle="modal" class="btn border-0 shadow-none text-primary discount-edit-btn" data-product-id="{{ $clearanceProduct->product_id }}"
