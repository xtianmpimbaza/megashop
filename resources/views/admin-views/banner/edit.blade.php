                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="h-100">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="form-label">{{ translate('banner_type') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="resource_id"
                                                   class="form-label">{{ translate('resource_type') }}</label>
                                            <select class="custom-select action-display-data" name="resource_type" required>
                                                ...
                                                <option
                                                    value="brand" {{ $banner['resource_type'] == 'brand'?'selected':'' }}>{{ translate('brand') }}</option>
                                            </select>
                                        </div>
