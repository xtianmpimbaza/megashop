    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4 pb-2">
            ...
            <div class="text-primary d-flex align-items-center gap-3 font-weight-bolder">
                ...
                <div class="ripple-animation" data-bs-toggle="modal" data-bs-target="#howItWorksModal">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                    <select name="bonus_type" id="bonus-type" class="form-select">
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end">
                                <a href="{{route('admin.customer.wallet.bonus-setup')}}" class="btn btn-secondary">{{translate('back')}}</a>
