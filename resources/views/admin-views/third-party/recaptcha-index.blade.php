                                ...
                                <div
                                    ...
                                    <label class="switcher " for="recaptcha-id">
                                        <input
                                            ...
                                            data-on-image="{{ dynamicAsset(path: 'public/assets/new/back-end/img/modal/google-analytics.png') }}"
                                            data-off-image="{{ dynamicAsset(path: 'public/assets/new/back-end/img/modal/google-analytics.png') }}"
