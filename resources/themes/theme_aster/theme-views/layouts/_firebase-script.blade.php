    ...
    try {
        ...
        @if($web_config['firebase_otp_verification'] && $web_config['firebase_otp_verification']['status'])
            window.onload = function() {
                ...
                // initializeFirebaseGoogleRecaptcha('recaptcha-container-manual-register', 'Manual Register');
        ...
        try {
            document.addEventListener("DOMContentLoaded", function() {
                var loginTriggers = document.querySelectorAll('[data-bs-target="#loginModal"]');
                var registerTriggers = document.querySelectorAll('[data-bs-target="#registerModal"]');

                loginTriggers.forEach(function(trigger) {
                    trigger.addEventListener('click', function() {
                        destroyRecaptcha('recaptcha-container-manual-register');
                        destroyRecaptcha('recaptcha-container-manual-login');
                        initializeFirebaseGoogleRecaptcha('recaptcha-container-manual-login', 'Manual Login');
                    });
                });
            ...
            function destroyRecaptcha(containerId) {
                ...
                var elementForRecaptcha = document.getElementById(containerId);
                if (elementForRecaptcha) {
                    elementForRecaptcha.innerHTML = '';
                }
            }
        } catch (e) {
            console.info('Error in recaptcha setup:', e);
        }
