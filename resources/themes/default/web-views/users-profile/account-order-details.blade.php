                                                        ...
                                                        <div class="media gap-3 align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <div class="d-flex flex-wrap gap-2 mt-2">
                                                                    @if($product && $order->payment_status == 'paid' && $product['digital_product_type'] == 'ready_product')
                                                                    ...
                                                                    @elseif($product && $order->payment_status == 'paid' && $product['digital_product_type'] == 'ready_after_sell')
