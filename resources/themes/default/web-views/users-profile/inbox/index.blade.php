...
@section('content')
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row no-gutters">
                            ...
                            <div class="chat--sidebar-card h-100">
                                <div class="chat--sidebar-top">
                                    ...
                                    <div class="heading_search px-0">
                                        <form
                                            class="rounded bg-white form-inline d-flex justify-content-center md-form form-sm active-cyan-2 mt-2 chatting-search-border">
                                            <input class="form-control form-control-sm border-0 me-3 w--0"
                                                   id="myInput" type="text" placeholder="{{translate('search')}}"
                                                   aria-label="Search">
                                            <span class="px-2"><i class="fa fa-search __color-9B9B9B"
                                ...
                                <div class="inbox_chat">
                                    @if(isset($allChattingUsers) && count($allChattingUsers) > 0)
                                        @foreach($allChattingUsers as $key => $chatting)
                                            ...
                                            <div
                                                class="list_filter chat_list {{ $loop->iteration == 1 ? 'active' : ''}} get-ajax-message-view"
                                                data-user-id="{{ $userId }}">
                                                    ...
                                                    <div class="chat_ib">
                                                        <div>
                                                            <div
                                                                ...
                                                                <h5 class="{{$chatting->unseen_message_count > 0 ? 'active-text' : ''}}">{{$userName}}</h5>
                                                                <span class="date">
                                                            ...
                                                            <div
                                                                ...
                                                                @if($chatting->message)
                                                                    <span
                                                                        class="last-msg">{{ $chatting->message }}</span>
                                                                ...
                                                                @if($chatting->unseen_message_count > 0)
                                                                    <span id="count-unread-messages-{{ $userId }}"
                                                                          class="new-msg badge btn--primary rounded-full">
                        ...
                        <section class="col-lg-8">
                                ...
                                <div class="bg-white Chat __shadow h-100 rounded-left-0">
                                    <div class="messaging ">
                                        <div class="inbox_msg position-relative">
                                            <div class="mesgs">
                                                <a class="msg-user cursor-default" href="javascript:">
                                                    @if($userType == 'admin')
                                                        <img alt="" class="img profile-image"
                                                             src="{{ getStorageImages(path: $web_config['fav_icon'], type: 'shop') }}">
                                                    @else
                                                        <img alt="" class="img profile-image"
                                                             src="{{ getStorageImages(path: $lastChatUser['image_full_url'], type: ($userType == 'vendor' ? 'shop':'avatar')) }}">
                                                    @endif
                                                ...
                                                <div class=" msg_history d-flex flex-column-reverse"
                                            ...
                                            if ($userType == 'admin') {
                                                ...
                                                $isVacationMode = checkVendorAbility(type: 'inhouse', status: 'vacation_status');
                                            } elseif ($userType == 'vendor') {
                                                $isTemporaryClosed = checkVendorAbility(type: 'vendor', status: 'temporary_close', vendor: $lastChatUser);
                                                $isVacationMode = checkVendorAbility(type: 'vendor', status: 'vacation_status', vendor: $lastChatUser);
                                            }
                                            ...
                                            ?>
                                               @if($canChat)
                                                    ...
                                                    <div class="input_msg_write">
                                                        <form
                                                            class="d-flex justify-content-center align-items-center md-form form-sm active-cyan-2 chatting-messages-form"
                                                            method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div
                                                                class="d-flex align-items-center m-0 px-3 gap-2 pt-3 align-self-start">
                                                                <label
                                                                    class="py-0 d-flex align-items-center m-0 cursor-pointer">
                                                                    ...
                                                                    <input type="file" id="select-media"
                                                                           class="h-100 position-absolute w-100 " hidden
                                                                           multiple
                                                            ...
                                                            <div class="position-relative d-flex w-100">
                                                                <div class="w-0 flex-grow-1">
                                                                    <textarea
                                                                        class="form-control ticket-view-control px-0 py-3 h-70px"
                                                                        name="message" rows="8" id="msgInputValue"
                                                                        ...
                                                                        <div class="overflow-x-auto pt-3 pb-2">
                                                                            <div>
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="d-flex gap-3 image-array"></div>
                                                                                    <div
                                                                                        class="d-flex gap-3 file-array"></div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <button type="submit" id="msgSendBtn"
                                                                        class="aSend no-gutter py-0 px-3 m-0 border-0 bg-transparent">
                                                                    <svg width="31" height="31" viewBox="0 0 31 31"
                                                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <rect width="31" height="31" rx="6"
                                                                              fill="currentColor"/>
                                                                        <path
                                                                            d="M21.2267 15.5548L10.2267 10.0548C10.1404 10.0116 10.0436 9.99437 9.94779 10.005C9.85198 10.0157 9.7613 10.0538 9.68665 10.1148C9.61536 10.1745 9.56215 10.253 9.53301 10.3413C9.50386 10.4296 9.49993 10.5243 9.52165 10.6148L10.8467 15.4998H16.5017V16.4998H10.8467L9.50165 21.3698C9.48126 21.4453 9.47888 21.5245 9.4947 21.6012C9.51052 21.6778 9.5441 21.7496 9.59273 21.8109C9.64136 21.8722 9.7037 21.9212 9.77472 21.954C9.84574 21.9868 9.92347 22.0025 10.0017 21.9998C10.0799 21.9993 10.157 21.9805 10.2267 21.9448L21.2267 16.4448C21.3086 16.4028 21.3773 16.3391 21.4253 16.2605C21.4733 16.182 21.4987 16.0918 21.4987 15.9998C21.4987 15.9077 21.4733 15.8175 21.4253 15.739C21.3773 15.6605 21.3086 15.5967 21.2267 15.5548Z"
                                                                            fill="white"/>
                                                                    </svg>
                                                                </button>
                                            ...
                                            <div
                                                class="temporarily-closed-sticky-alert {{ $isVacationMode && !$isTemporaryClosed ? '' : 'd-none' }}">
                                                <div class="alert-box">
                                                    <div><img
                                                            src="{{ theme_asset('public/assets/front-end/img/icons/warning.svg') }}"
                                                            alt=""></div>
                                                    <div>
                                                        {{ translate('sorry') }} !
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <button type="button"
                                                                class="close close-element-onclick-by-data"
                                                                aria-label="Close"
                                                                data-selector=".temporarily-closed-sticky-alert">
                                               ...
                                               <div
                                                class="temporarily-closed-sticky-alert {{ $isTemporaryClosed ? '' : 'd-none' }}">
                                                <div class="alert-box">
                                                    <div><img
                                                            src="{{ theme_asset('public/assets/front-end/img/icons/warning.svg') }}"
                                                            alt=""></div>
                            ...
                            @else
                                <div
                                    class="card Chat __shadow h-100 d-flex flex-column justify-content-center rounded-left-0">
                                    <div class="text-center">
                                        <img src="{{theme_asset(path: 'public/assets/front-end/img/empty-msg.png')}}"
                                             alt="">
    ...
    <span id="chatting-post-url"
          data-url="{{ Request::is('chat/vendor') ? route('messages').'?vendor_id=' : route('messages').'?delivery_man_id=' }}"></span>
    <span id="get-file-icon" data-default-icon="{{theme_asset("public/assets/front-end/img/default-icon.png")}}"
          data-word-icon="{{theme_asset("public/assets/front-end/img/default-icon.png")}}"></span>
    ...
    <span id="get-video-preview-icon"
          data-icon="{{ theme_asset('public/assets/front-end/img/icons/carbon_play-filled.svg') }}"></span>
@endsection
