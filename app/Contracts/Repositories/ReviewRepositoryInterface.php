...
interface ReviewRepositoryInterface extends RepositoryInterface
{
     ...
     * @return Collection|LengthAwarePaginator
     */
    public function getListWhereHas(string $whereHas, array $whereHasFilter  , array $orderBy = [], string $searchValue = null, array $filters = [], array $relations = [], array $nullFields = [], bool $globalScope = true, int|string $dataLimit = DEFAULT_DATA_LIMIT, int $offset = null): Collection|LengthAwarePaginator;
